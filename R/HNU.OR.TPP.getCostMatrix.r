...
setGeneric("HNU.OR.TPP.getCostMatrix", function(object,...)  standardGeneric("HNU.OR.TPP.getCostMatrix") )
 setMethod("HNU.OR.TPP.getCostMatrix",signature(object="HNUGeoSituation"),
  function(object,...){  
    li<-list(...) 
