...
#' @param n0 an object of class \code{"numeric"} with a length of 2 (x/y-coordinates) or a class derived from \code{"Node"}. Used as origin.
#' @param n1 an object of class \code{"numeric"} with a length of 2 (x/y-coordinates) or a class derived from \code{"Node"}.
